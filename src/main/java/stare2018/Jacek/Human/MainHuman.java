package stare2018.Jacek.Human;

public class MainHuman {

    public static void main(String[] args) {

//      String stare2018.Jacek = newHuman();
...
//      A druga rzecz do poprawy to jest typ zmiennej stare2018.Jacek. Zmienna stare2018.Jacek (zmienne piszemy z malej litery :P ) musi byc tego samego typu
//      co obiekt na ktory wskazuja. Czyli poprawnie bedzie:   Human jacek = new Human();

        Human jacek = new Human("stare2018/Jacek", 27, 73.3, true);
        Human brat2 = new Human("stare2018/Pawel",30,true);
